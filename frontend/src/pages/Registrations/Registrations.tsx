...
const Registrations = () => {
    ...
    //     e.preventDefault();
    //     axios.post(`baseURL/auth/register/`, user).then(res => {
                                ...
                                <div className=" col-lg-12 col-md-6 col-sm-6 create-new-account">
                                    ...
                                    {/* <form className="register-form outer-top-xs" role="form" onSubmit={handleSubmit}> */}
                                        ...
                                        <div className="form-group">
                                            ...
                                            {/* <input type="email" className="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="username" onChange={getData} /> */}
                                        </div>
                                        <div className="form-group">
                                            ...
                                            {/* <input type="email" className="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="password" onChange={getData} /> */}
                                        </div>
                                        <div className="form-group">
                                            ...
                                            {/* <input type="email" className="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="confirm_password" onChange={getData} /> */}
                                        </div>
